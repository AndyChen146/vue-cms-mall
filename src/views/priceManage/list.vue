<template>
  <div class="con-right">
    ...
    <div class="filter-wrap">
      <h2 class="wrap-title">筛选查询<button type="button" class="addimport fr"><i class="el-icon-search"></i>同步K3计算价格</button></h2>
      ...
      <div class="result-con" v-loading="loading">
        <div class="public-table">
          <div class="th">
            ...
            <span class="span140">K3编码</span>
            <span class="span100">商品分类</span>
            <span class="span200">商城现价</span>
            <span class="span200">K3计算价格</span>
            <span class="span140">审核状态</span>
            <span class="span120">操作</span>
          ...
          <div v-show="!nodatashow">
            <div class="td" v-for="(item,index) in list" :key="index">
              ...
              <span class="span140">{{item.material_ksn}}</span>
              <span class="span100">{{item.cate_name}}</span>
              <span class="span200" v-if="item.product_price_info.length>0">
              ...
              <span class="span120">
                <router-link :to="{path:'/price/list/edit',query:{'product_id':item.product_id}}" class="edit C0067ED">编辑</router-link>
                <!-- <a href="javascript:;" class="delete" @click="del(item.product_id)">删除</a> -->
                <a href="javascript:;" class="log C0067ED span20">日志</a>
              </span>
